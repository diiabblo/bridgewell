;; Add Bitcoin Block Triggers
;; Implement contracts that read Bitcoin state for transaction triggers

;; This contract implements Add Bitcoin Block Triggers for the Bridgewell platform
