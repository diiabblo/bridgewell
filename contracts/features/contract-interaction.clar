;; Add Contract Call Utilities
;; Create utility functions for contract calls using Stacks.js

;; This contract implements Add Contract Call Utilities for the Bridgewell platform
